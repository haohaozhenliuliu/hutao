...
在就业压力就业难度不断加大的今天，许多面临毕业的大学生们纷纷将目标投向了考公考编，但是在学习的过程中，许多同学都为面对浩如烟海且包罗万象的常识题目而头痛不已。常识这一板块知识包容面极广，上至天文下至地理，前历尧舜后至今人，在题目搜集以及快速知晓正确且准确的答案方面令一众同学面露苦色。为了解决考公人的心腹大患，提高同学们的学习效率，由我们小组设计，可以快速解答公考常识题目的公考问答助手应运而生。

为了保证题目的准确程度，我们搜集了近十几年的各地公考以及事业单位考试的常识板块的题目以及市面上常见的一些公考机构的常识板块资料和一些基础的常识题目，数据总量高达四万道，基本涵盖了常见的常识点以及可能会考到的方面，不可不谓面面俱到。同时我们将模型进行了长时间的训练，将问题回答的准确性达到了可接受的程度，并且响应速度较快，有不错的效率，可以有效减少学生在使用常规方法查询答案的时间，达到了我们的预期目标。
...
| 基座模型| 微调数据量 | 训练次数 |  |
|:------:|:------:|:-------:|:---------|
|InternLM-chat-7b|46933 conversations|12 epochs||
